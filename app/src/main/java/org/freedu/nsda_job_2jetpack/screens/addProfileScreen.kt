...
fun AddProfileScreen(
    ...
    Column(
        verticalArrangement = Arrangement.Center, // consistent spacing
        ...
        Button(
            onClick = {
                if (name.isNotEmpty() && email.isNotEmpty()) {
                    viewModel.insert(Profile(name = name, email = email, phone = phone))
            ...
            shape = RoundedCornerShape(26.dp) // Rounded button
        ) {
